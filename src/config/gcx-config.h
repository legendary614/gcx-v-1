/* src/config/gcx-config.h.  Generated from gcx-config.h.in by configure.  */
/* src/config/gcx-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "gcx.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GCX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GCX Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gcx"
