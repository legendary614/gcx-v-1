...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GC:
            return QString("GC");
        case mGC:
            return QString("Milli-GC (1 / 1" THIN_SP_UTF8 "000)");
        case uGC:
            return QString("Micro-GC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case GC:
            return QString("TestGCs");
        case mGC:
            return QString("Milli-TestGC (1 / 1" THIN_SP_UTF8 "000)");
        case uGC:
            return QString("Micro-TestGC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
